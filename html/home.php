...
<html>
	...
	<body>
		...
		$category_o = ''; $data_o = ''; foreach($site_jobs['site_data']['openClosed']['open_jobs'] as $day => $aV){ 
			$category_o.= "'" . $day."',";
			$data_o.= $aV.",";
		 }
		 $category_o = rtrim($category_o,',');
 		 $data_o = rtrim($data_o,',');


		$category_e = ''; $data_e = ''; foreach($site_jobs['site_data']['openClosed']['expired_jobs'] as $day => $aV){ 
			$category_e.= "'" . $day."',";
			$data_e.= $aV.",";
		 }
		 $category_e = rtrim($category_e,',');
 		 $data_e = rtrim($data_e,',');
			...
			<div class="details-container">
				...
				<!-- <div class="ind-details-container whole">
					<div class="actual-details-container">
						<div class="box-heading">Open Jobs</div>
							<div id = "open-jobs"></div>
					</div>
				</div>
				<div class="ind-details-container whole">
					<div class="actual-details-container">
						<div class="box-heading">Close Jobs</div>
			  ...
			  $('#open-jobs').highcharts({
				  ...
				  xAxis: {
					allowDecimals:false,
						  min: .5,
						  max: 5.5,
					categories: [<?php echo $category_o; ?>],
					},
				  yAxis: {
				  gridLineWidth: 0,
		  ...
		  $('#closed-jobs').highcharts({
				  ...
				  xAxis: {
					allowDecimals:false,
						  min: .5,
						  max: 5.5,
					categories: [<?php echo $category_e; ?>],
					},
				  yAxis: {
				  gridLineWidth: 0,
				  minorGridLineWidth: 0,
