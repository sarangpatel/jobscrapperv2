...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="topmenu">
  <tr>
    <td colspan="8"><h1>Smart Translator Language Selection Output <a title="Download" href="http://www.marghoobsuleman.com/jquery-image-dropdown" class="small">Download Javascript Image Dropdown</a></h1></td>
  </tr>
  <tr>
...
print_r($_POST);
echo"<hr>";*/
$_POST['flag_2'] = explode(",", $_POST['flag_2']);
$_POST['lang_name_2'] = explode(",", $_POST['lang_name_2']);
print_r($_POST);
echo "</pre>";
?>
    </td>
